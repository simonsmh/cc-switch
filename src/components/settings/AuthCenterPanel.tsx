        ...
        <div className="mb-4 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl overflow-hidden">
            <svg width="40" height="40" viewBox="0 0 1200 1200" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <mask id="kiro-panel-mask" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="272" y="202" width="655" height="796">
                <path d="M926.578 202.793H272.637V997.857H926.578V202.793Z" fill="white" />
              </mask>
              <g mask="url(#kiro-panel-mask)">
          ...
          <div>
            <h4 className="font-medium">Kiro</h4>
            <p className="text-sm text-muted-foreground">
              {t("settings.authCenter.kiroDescription", {
                defaultValue: "管理 Kiro 账号",
              })}
            </p>
          </div>
        </div>
